<form action="send-message">
	<p>
		<input id="messageUsername" name="sendMessageForm.receiverName" type="text" pattern="[a-zA-Z]{6,32}" maxLength="32" size="35"
			placeholder="Nom du destinataire..." required>
	</p>

	<p>
		<input id="messageObject" name="sendMessageForm.subject" type="text" maxLength="32" size="35" placeholder="Objet du message..." required>
	</p>
